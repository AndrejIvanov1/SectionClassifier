...
Options:
	...
	--model_file <model_file> Path to saved model
	--epoch <epoch> Number of training epochs [10]
	--dim <dim> Size of words vectors [100]
	--lr <lr> Learning rate [0.25]
	--n_gram <n_gram> Max lenght of word n-grams [1]
...
def read_labels(lines):
	return list(map(lambda line: _read_label(line), lines))
